      ...
      <div className={styles.letterBackground}>
        <Paper className={styles.letter} elevation={16}>
          ...
          <div className={styles.roles}>
            <p>
              &emsp; Our new clinic workflow centers around the <strong>Patient Advocate</strong> training, 
              which <u>all volunteers will receive</u>. After 3 quarters in the Patient Advocate role, volunteers 
          ...
          <div className={styles.training}>
            <p>
              &emsp; As stated before, we are making the <strong>Patient Advocate</strong> training available to all 
